...
import type { ScrollTextBlock as ScrollTextBlockProps } from 'src/payload-types';
...
// Main Export
export const ScrollTextBlock: React.FC<Props> = ({
  className,
  text,
  animationType,
  textOpacity,
  ...
  return (
    <div
      className={cn(
        'mx-auto w-full px-12 md:px-24 lg:px-48 md:py-32 align-middle flex justify-center bg-neutral-50 dark:bg-background',
        {
    ...
    >
      <TextGradientScroll
        ...
        className={cn('py-8 text-neutral-900 dark:text-neutral-100', {
